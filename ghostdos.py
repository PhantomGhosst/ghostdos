...
print("  Welcome To GhostDos V.1")
print(" Time To Ghost Those Skids")
print("  Made By PhantomGhost")
...
def main(argv):
	parser = argparse.ArgumentParser(description='Sending unlimited amount of requests in order to perform DoS attacks. Written by PhantomGhost')
